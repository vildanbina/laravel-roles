...
class LaravelPermissionsController extends Controller
{
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        return redirect()->route('laravelroles::roles.index')
                            ->with('success', trans('laravelroles.flash-messages.permission-create', ['permission' => $permission->name]));
    }
    ...
    public function update(UpdatePermissionRequest $request, $id)
    {
        ...
        return redirect()->route('laravelroles::roles.index')
            ->with('success', trans('laravelroles.flash-messages.permission-updated', ['permission' => $permission->name]));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('laravelroles::roles.index'))
                    ->with('success', trans('laravelroles.flash-messages.successDeletedItem', ['type' => 'Permission', 'item' => $permission->name]));
    }
}
