<div class="form-group has-feedback row {{ $errors->has('model') ? ' has-error ' : '' }}">
    <label for="model" class="col-12 control-label">
        {{ trans("laravelroles.forms.permissions-form.permission-model.label") }}
    </label>
    <div class="col-12">
        <select name="model" id="model">
            <option value="">{{ trans("laravelroles.forms.permissions-form.permission-model.placeholder") }}</option>
