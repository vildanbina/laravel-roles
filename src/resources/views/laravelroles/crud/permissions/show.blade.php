...
@section(config('roles.titleExtended'))
    {!! trans('laravelroles.titles.show-permission') !!}
@endsection
                ...
                <div class="{{ $containerClass }} {{ $bootstrapCardClasses }}">
                    <div class="{{ $containerHeaderClass }}">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span id="card_title">
                                @isset($typeDeleted)
                                    {!! trans('laravelroles.titles.show-permission-deleted', ['name' => $item->name]) !!}
                                @else
                                    {!! trans('laravelroles.titles.show-permission', ['name' => $item['permission']->name]) !!}
                                @endisset
                            </span>
                    ...
                    <div class="{{ $containerBodyClass }}">
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {!! trans('laravelroles.cards.permission-info-card.permission-id') !!}
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {!! trans('laravelroles.cards.permission-info-card.permission-name') !!}
                                <span class="badge badge-pill">
                                    @isset($typeDeleted)
                                        {{ $item->name }}
                                    @else
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {!! trans('laravelroles.cards.permission-info-card.permission-slug') !!}
                                <span class="badge badge-pill">
                                    @isset($typeDeleted)
                                        {{ $item->slug }}
                                    @else
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {!! trans('laravelroles.cards.permission-info-card.permission-model') !!}
                                <span class="badge badge-pill">
                                    @isset($typeDeleted)
                                        {{ $item->model }}
                                    @else
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {!! trans('laravelroles.cards.permission-info-card.permission-desc') !!}
                                <span class="badge badge-pill">
                                    @isset($typeDeleted)
                                        @if($item->desc)
                                            {{ $item->desc }}
                                        @else
                                            <span class="text-muted">
                                                {!! trans('laravelroles.cards.permission-info-card.none') !!}
                                            </span>
                                        @endif
                                    @else
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {!! trans('laravelroles.cards.permission-info-card.permission-roles') !!}
                                @isset($typeDeleted)
                            ...
                            <li id="accordion_roles_users" class="list-group-item accordion @if($item['users']->count() > 0) list-group-item-action accordion-item collapsed @endif" data-toggle="collapse" href="#collapse_roles_users">
                                <div class="d-flex justify-content-between align-items-center" @if($item['users']->count() > 0) data-toggle="tooltip" title="{{ trans("laravelroles.tooltips.show-hide") }}" @endif>
                                    {!! trans('laravelroles.cards.permission-info-card.permission-users') !!}
                                ...
                                @if($item['users']->count() > 0)
                                    <div id="collapse_roles_users" class="collapse" data-parent="#accordion_roles_users" >
                                        <table class="table table-striped table-sm mt-3">
                                            <caption>
                                                @isset($typeDeleted)
                                                    {!! trans('laravelroles.cards.permissions-card.permissions-table-users-caption', ['permission' => $item->name]) !!}
                                                @else
                                                    {!! trans('laravelroles.cards.permissions-card.permissions-table-users-caption', ['permission' => $item['permission']->name]) !!}
                                                @endisset
                                            </caption>
                                            <thead>
                                                <tr>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge badge-pill">
                                    ...
                                    @else
                                        {!! $item['permission']->created_at->format(trans('laravelroles.date-format')) !!}
                                    @endisset
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge badge-pill">
                                    ...
                                    @else
                                        {!! $item['permission']->updated_at->format(trans('laravelroles.date-format')) !!}
                                    @endisset
                                </span>
                            </li>
                            @isset($typeDeleted)
